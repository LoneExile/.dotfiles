...
-- This file contains all key mappings and shortcuts
...
-- Clipboard keymaps
-- You should use these keybindings so that they are still easy to use, but dont conflict
...
-- Snacks keymaps (file explorer, terminal, etc.)
