...
let
  ...
  fixtures = {
    ...
    profileCombinations = {
      ...
      pairs = [
        { minimal.enable = true; development.enable = true; }
        { development.enable = true; work.enable = true; }
        { work.enable = true; personal.enable = true; }
        { development.enable = true; personal.enable = true; }
      ];
      
      triples = [
        { minimal.enable = true; development.enable = true; work.enable = true; }
        { development.enable = true; work.enable = true; personal.enable = true; }
        { minimal.enable = true; development.enable = true; personal.enable = true; }
      ];
  ...
  scenarios = {
    ...
    generateUpgradePath = startConfig: steps:
      let
    ...
    generateModuleCombinations = moduleList:
      let
        # Generate all possible combinations of modules
        combinations = lib.genList (i:
          lib.genList (j: 
    ...
    generateErrorCases = {
      ...
      invalidModuleConfigs = [
        ...
        { enable = true; package = "not-a-package"; }
        { enable = true; settings = "not-an-attrs"; }
      ];
    };
  };
  ...
  validation = {
    ...
    validateTestModule = moduleConfig:
      let
