  ...
  validationTests = testLib.mkTest {
    ...
    assertions = [
      ...
      (testLib.assertions.assertHasAttr "moduleValidation has validateModuleStructure" 
        "validateModuleStructure" validation.moduleValidation)
      (testLib.assertions.assertHasAttr "moduleValidation has validateModuleDependencies"
        "validateModuleDependencies" validation.moduleValidation)
      ...
      (testLib.assertions.assertHasAttr "configValidation has validateFullConfig"
        "validateFullConfig" validation.configValidation)
      ...
      (testLib.assertions.assertHasAttr "validationAssertions has assertValidConfig"
        "assertValidConfig" validation.validationAssertions)
      ...
      in testLib.assertions.assertTrue "valid module structure passes validation" result.valid)
      ...
      in testLib.assertions.assertFalse "invalid module structure fails validation" result.valid)
      ...
      in testLib.assertions.assertTrue "valid config passes validation" result.valid)
      ...
      (let
        ...
        result = validation.configValidation.validateFullConfig testConfig "aarch64-darwin";
      in testLib.assertions.assertFalse "invalid config fails validation" result.valid)
    ];
  };
