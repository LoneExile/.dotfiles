...
return gears.table.join(
	...
	end, { description = "Move focused window to next screen", group = "Screen" }),
	awful.key(
		{ modkey },
		"#30",
	...
	end, { description = "Toggle Bar", group = "Client" }),
	...
	end, { description = "Client switcher", group = "Launcher" }),
	awful.key({ "Control" }, "#65", function()
		awful.spawn("rofi -show drun")
	end, { description = "Run prompt rofi", group = "Launcher" }),
	...
	end, { description = "Utility", group = "Applications" }),
