...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
  function(s)
    ...
    if s.index == 1 then
      ...
      require("crylia_bar.left_bar")(s, { s.systray, s.taglist })
      require("crylia_bar.center_bar")(s, { s.tasklist })
      require("crylia_bar.right_bar")(s, { s.ram_info, s.cpu_usage, s.audio, s.kblayout, s.clock, s.date, s.powerbutton })
    ...
    if s.index == 2 then
      ...
      require("crylia_bar.left_bar")(s, { s.taglist })
      require("crylia_bar.center_bar")(s, { s.tasklist })
      require("crylia_bar.right_bar")(s, { s.ram_info, s.cpu_usage, s.audio, s.kblayout, s.clock, s.date, s.powerbutton })
      -- require("crylia_bar.dock")(s, user_vars.dock_programs)
    end
