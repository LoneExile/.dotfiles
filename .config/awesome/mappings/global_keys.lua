...
return gears.table.join(
  ...
  awful.key({ modkey }, "#23",
    ...
    { description = "Client switcher", group = "Launcher" }),
  awful.key({ "Control" }, "#65",
  ...
  awful.key({ "Control" }, "#108",
    function() awful.util.spawn("/bin/bash -c $HOME/.config/rofi/utility/util.sh") end,
    { description = "Utility", group = "Applications" }),
  awful.key(
    { modkey },
    "#26",
    function()
  ...
  awful.key(
    ...
    function(c)
      ...
      awful.spawn.easy_async_with_shell(
        ...
        function(stdout)
          awful.spawn.easy_async_with_shell("pkexec /usr/bin/xfpm-power-backlight-helper --set-brightness " ..
